  ...
  <body onload="initTmap();">
    <div class="cover-container d-flex w-100 h-100 p-3 mx-auto flex-column">
      <header class="masthead mb-auto">
        ...
        <div>
            <button class="btn btn-info" id="btn1"><a href="http://eyecan.tk/setting1?device_id={{$device_id}}" class="deco">첫번째 목적지</a></button>
            <button class="btn btn-info" id="btn2"><a href="http://eyecan.tk/setting2?device_id={{$device_id}}" class="deco">두번째 목적지</a></button>
            <button class="btn btn-info" id="btn3"><a href="http://eyecan.tk/setting3?device_id={{$device_id}}" class="deco">세번째 목적지</a></button>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-2">
            	<form id="info" action="http://eyecan.tk/setting1?device_id={{$device_id}}" method="post">
		        	{!! csrf_field() !!}
		        	<input type="text" name="address" id="address" />
		        	<input type="text" name="newaddress" id="newaddress" />
		        	<input type="text" name="lon" id="lon" />
		        	<input type="text" name="lat" id="lat" />
		        	<button class="btn btn-outline-info" id="signup" onclick="warn();" type="submit">등록하기</button>
		        </form>
